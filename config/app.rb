...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'demo-ac-dtp.com'
  config.app_name = 'Demo_ac_dtp'
  config.mailer.from = 'Demo_ac_dtp <no-reply@demo-ac-dtp.com>'
  ...
  #
  config.app_secret = '1C9w_TeCSBHj-uK1345XrSWjraZW6SZoiAuQ7aLL3Na6yodEzUoX6B70zfOv_NycPwU'
